...
<body>
    ...
    <nav class="navbar">
        <div class="max-width">
            <div class="logo"><a href="#"><i class="fa-solid fa-house-chimney-medical fa-beat" style="color: #04c3a3;"></i> Global<span>Hospital</span></a></div>
            <ul class="menu">
                <li><a href="#home" class="menu-btn">Home</a></li>
                <li><a href="#about" class="menu-btn"><i class="fa-solid fa-user-doctor fa-beat-fade" style="color: #74C0FC;"></i> Doctor</a></li>
                <li><a href="#services" class="menu-btn">Surgery</a></li>
                <li><a href="#skills" class="menu-btn">Slot Booking</a></li>
                <li><a href="#contact" class="menu-btn">Contact</a></li>
                <li><a href="#teams" class="menu-btn"><i class="fa-solid fa-lock fa-bounce"></i> Admin</a></li>
    ...
    <section class="home" id="home">
        <div class="max-width">
            <div class="home-content">
                ...
                <a href="#"><i class="fa-solid fa-calendar-check fa-shake fa-lg" style="color: #ffffff;"></i> Take Appointment...</a>
            </div>
        </div>
    </section>
